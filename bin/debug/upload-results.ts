...
// pnpm exec tsx bin/debug/upload-results.ts -j 0197d06b-a4ae-7178-bc27-64aa8b288ce8 -r tests/assets/results-with-pii.csv -l tests/assets/error-log.txt
// To upload logs only
// pnpm exec tsx bin/debug/upload-results.ts -j 0197d06b-a4ae-7178-bc27-64aa8b288ce8 -l tests/assets/error-log.txt
// To upload results only
// // pnpm exec tsx bin/debug/upload-results.ts -j 0197d06b-a4ae-7178-bc27-64aa8b288ce8 -r tests/assets/results-with-pii.csv
