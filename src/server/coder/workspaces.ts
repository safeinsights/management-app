...
import { CoderSessionUser, CoderUser, CoderWorkspace, CoderWorkspaceEvent } from './types'
...
export async function getCoderWorkspaceUrl(
    studyId: string,
    workspaceId: string,
    ...
    try {
        ...
        const url = await generateWorkspaceUrl(studyId, sessionUser)
