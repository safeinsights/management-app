...
// Not NEXT_PUBLIC_: the build is shared across environments, so a build-time inlined flag could
// not vary per-env. Threaded to the client via the websocket provider.
