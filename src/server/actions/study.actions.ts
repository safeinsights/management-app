...
export const fetchStudiesForOrgAction = orgAction(
    async ({ orgSlug }) => {
        try {
            ...
            logger.error(e)
            throw new ActionFailure({ message: 'Failed to fetch studies' })
        }
    },
    z.object({
        orgSlug: z.string(),
...
export const fetchStudiesForCurrentResearcherAction = researcherAction(async () => {
    try {
        ...
        logger.error(e)
        throw new ActionFailure({ message: 'Failed to fetch studies for researcher' })
    }
})
...
export const getStudyAction = userAction(async (studyId) => {
    try {
        ...
        logger.error(e)
        throw new ActionFailure({ message: `Failed to get study ${studyId}` })
    }
}, z.string())
...
export const approveStudyProposalAction = orgAction(
    async ({ studyId, orgSlug }) => {
        try {
            ...
            logger.error(e)
            throw new ActionFailure({ message: 'Failed to approve study proposal' })
        }
    },
    z.object({
        studyId: z.string(),
...
export const rejectStudyProposalAction = orgAction(
    async ({ studyId, orgSlug }) => {
        try {
            ...
            logger.error(e)
            throw new ActionFailure({ message: 'Failed to reject study proposal' })
        }
    },
    z.object({
        studyId: z.string(),
