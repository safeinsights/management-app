...
import { Box, Divider, Group, MantineTheme, Stack, Text, UnstyledButton } from '@mantine/core'
...
export const LaunchIDEButton: FC<{ onClick: () => void; language: Language }> = ({ onClick, language }) => (
    <UnstyledButton onClick={onClick} style={{ width: 320, height: 200 }}>
        <Box style={(theme) => buttonBoxStyles(theme)}>
            <Stack align="center" justify="center" gap={4}>
