    ...
    return (
        <div className={pageStyles}>
            ...
            <SignedIn>
                ...
                <main className={mainStyles}>Hello World, found {studies.length} records
            ...
            <Paper bg="#f5f5f5" shadow="none" p={30} radius="sm">
                <TextInput label="Login"  placeholder="Email address or phone number" aria-label="Email address or phone number"/>
                <PasswordInput mt={10} placeholder="Password" aria-label="Password"/>
                <Group>
                <Checkbox mt={5}label="Remember me" aria-label="Remember me"/>
                <Anchor href="https://www.safeinsights.org/" target="_blank" mt={5}>Forgot password?</Anchor>
                </Group>
            </Paper>
            </main>
            </SignedIn>
