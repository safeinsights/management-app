                    ...
                    >
                        ...
                        <Group p={2} gap="md">
                            ...
                            <TextInput
                                ...
                                radius="none"
                                placeholder="Placeholder-will programatically pull in value from pre-proposal stage"
                            />
                        </Group>
                        <Group p={2} gap="lg">
                            ...
                            <Input
                                name="textInput"
                                control={control}
                                aria-label="Prinicipal Investigator"
                                radius="none"
                            />
                        </Group>
                        <Group p={2} gap="lg">
                        ...
                        <Stack align="stretch">
                            <Group p={2} gap="lg">
                                ...
                                <Select
                                    name="select"
                                    control={control}
                                    aria-label="Your favorite library"
                            ...
                            <Group p={2} gap="lg">
                                ...
                                <TextInput
                                    name="containerUrl"
                                    control={control}
                                    aria-label="Container URL"
                                    radius="none"
                                    placeholder="Placeholder-will pull in value programatically"
                                />
                            </Group>
                        </Stack>
