...
// researchers. New jobs no longer create APPROVED-RESULT rows (results are decrypted client-side),
// so this is only reachable for pre-encryption studies. Delete it — along with
// pathForStudyJobResults (src/lib/paths.ts) and any remaining plaintext S3 objects — once legacy
// studies age out.
