...
describe('NewProposalReviewView', () => {
    ...
    describe('already-decided guard', () => {
        it('hides decision section and action bar when study is APPROVED', () => {
            ...
            renderWithProviders(<NewProposalReviewView orgSlug="test-org" study={approvedStudy} />)
        ...
        it('hides decision section and action bar when study is REJECTED', () => {
            ...
            renderWithProviders(<NewProposalReviewView orgSlug="test-org" study={rejectedStudy} />)
