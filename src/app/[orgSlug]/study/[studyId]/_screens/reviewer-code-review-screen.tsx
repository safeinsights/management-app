...
// page.
export async function ReviewerCodeReviewScreen({ study, raw, orgSlug, dashboardHref }: ScreenComponentProps) {
    ...
    const nav = resolveReviewerStepNav('reviewer-code-review', projectStudyState(raw), {
        orgSlug,
        studyId: study.id,
        dashboardHref,
    })
