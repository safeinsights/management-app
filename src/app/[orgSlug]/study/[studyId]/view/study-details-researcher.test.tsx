...
// Study Status + Previous. OTTER-614: "Previous" walks back to the approved-code step
// (/view?step=code) — results is no longer terminal.
...
describe('StudyDetailsResearcher', () => {
    ...
    it('renders a Previous link back to the code step (/view?step=code)', async () => {
        const { org, study, latestJob } = await setupStudyAction({ orgSlug: 'openstax', orgType: 'lab' })
