...
import { StudyResults } from '../review/study-results'
import Link from 'next/link'
import { ResearcherReviewButtons } from '../review/researcher-review-buttons'
import { Routes } from '@/lib/routes'

export default async function StudySubmitPage(props: {
    params: Promise<{
        orgSlug: string
        studyId: string
    }>
