...
- There are two admin types and screens:
    - A organization admin is a member of an organization who can invite other users to that organization. Their admin screen is located at: `/admin/team/organization/<org slug>/admin` From their they can administer the users in their organization.
